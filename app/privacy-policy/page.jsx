      ...
      {/* <Layout> */}
        <div className="min-h-screen prose flex flex-col m-auto">
          <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
            ...
            <p className="mb-4">
              Thank you for visiting Sounding Board. Your privacy is important
            ...
            <p className="mb-4">
              When you use Sounding Board, we may collect certain information
              about you, including:
            </p>
            ...
            <p className="mb-4">
              ...
              please contact us at <a href='mailto:f.strauf@gmail.com'>here</a>.
            </p>
          </div>
        </div>
      {/* </Layout> */}
